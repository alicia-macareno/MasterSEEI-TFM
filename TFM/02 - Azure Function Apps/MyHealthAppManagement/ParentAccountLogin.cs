namespace myhealthcaresystem
{
    ...
    public static class ParentAccountLogin
    {
        [FunctionName("ParentAccountLogin")]
        public static async Task<HttpResponseMessage> Run([HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "ParentAccountLogin")] HttpRequestMessage req, Microsoft.Extensions.Logging.ILogger logger)
        {
            logger.LogInformation("ParentAccountLogin Azure API execution started...");
            ...
            using (SqlConnection conn = new SqlConnection(str))
            {
                try
                {
                    ...
                    var command = new SqlCommand("dbo.uspParentAccountLogin", conn);
